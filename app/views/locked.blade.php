...
@section('content')
		<div class="block-absolute-center login-form">
			...
			<div class="text-center m-b-10">
                ...
                <h2 class="text-white">Service Locked<br></h2>
			</div>

            {{ link_to('/', 'We will be back soon!', ['class' => 'btn btn-gray btn-block btn-lg']) }}
		</div>
@stop
...
@section('footer')
    <script>
      $(".backstretch").backstretch([
        ...
        "backgrounds/wg_blurred_backgrounds_18.jpg",
